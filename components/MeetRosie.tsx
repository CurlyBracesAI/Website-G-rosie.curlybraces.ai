const feats = [
  {
    ...
    body: "Rosie reviews your onboarding pipeline and proactively recommends next steps for each lead.",
  },
  {
  ...
  },
  {
    ...
    body: "New staff ask Rosie: she walks them through the onboarding protocol step by step.",
  },
  {
    title: "Calendar sync",
  ...
  return (
    <section className="site-section" id="features">
      ...
      <p style={{ maxWidth: 560, marginTop: "0.5rem" }}>
        Rosie isn&apos;t a generic chatbot. She&apos;s trained specifically on therapy onboarding workflows: the stages, the scripts, the clinical sensitivity required. She plans, guides, drafts, and flags.
      </p>
      ...
      <div style={{
        ...
        <div style={{
          ...
          You have 3 onboarding journeys that need attention today. Sarah K. hasn&apos;t responded in 48hrs. I&apos;ve drafted a follow-up for your review. Want me to walk you through the others?
        </div>
